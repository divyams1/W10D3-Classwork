...
var _clock = __webpack_require__(/*! ./clock */ "./frontend/clock.jsx");
...
var Tabs = function (_React$Component) {
    ...
    function Tabs(props) {
        ...
        var _this = _possibleConstructorReturn(this, (Tabs.__proto__ || Object.getPrototypeOf(Tabs)).call(this, props)); //props = [{ content: title }, { content: title }];


        _this.tabs = props["tabs"];
        _this.state = { selected: 0 };
        _this.addContent = _this.addContent.bind(_this);
        return _this;
    }

    _createClass(Tabs, [{
        key: "addContent",
        value: function addContent(idx) {
        ...
        value: function render() {
            ...
            var title = this.tabs.map(function (object, idx) {
                return _react2.default.createElement(
                    "h1",
                    { key: idx, onClick: function onClick() {
                            return _this2.addContent(idx);
                        } },
                    object["title"]
                );
            });
            var content = this.tabs.map(function (object, idx) {
                return _react2.default.createElement(
                    "article",
                    { key: idx, className: _this2.state.selected === idx ? 'show' : 'content-tab' },
                    object["content"]
                );
            });
            return _react2.default.createElement(
...
var _root = __webpack_require__(/*! ./frontend/root */ "./frontend/root.jsx");
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // // < Clock/>
    // <Tabs tabs={articles} />
    _react2.default.createElement(_root2.default, null), document.getElementById('root'));
});
